...
<head>
    ...
    <style>
        * {
        ...
        /* Main content margin akan mengikuti class dari sidebar user */
        ...
        <main class="flex-1 min-w-0">
            ...
            <div class="bg-white shadow-sm border-b sticky top-0 z-20">
                <div class="px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="hidden md:block">
                            <h1 class="text-lg sm:text-xl font-bold text-gray-800">@yield('page-title', 'Dashboard Warga')</h1>
                            <p class="text-xs sm:text-sm text-gray-500">@yield('page-description', 'Kelola laporan dan pantau aktivitas Anda')</p>
                        </div>
                    </div>
                ...
                <div class="block md:hidden px-4 pb-3">
                    <h1 class="text-lg font-bold text-gray-800">@yield('page-title', 'Dashboard Warga')</h1>
                    <p class="text-xs text-gray-500">@yield('page-description', 'Kelola laporan dan pantau aktivitas Anda')</p>
                </div>
            </div>
